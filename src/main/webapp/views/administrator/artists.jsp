				...
				<div class="row tile_count">
					<div
						...
						<div class="right">
							...
							<spring:message code="top.purchasers"></spring:message></span>
							<div class="count">
								<jstl:out value="${totalPurchasers}"></jstl:out>
							</div>
						</div>
					</div>
					<div
						...
						<div class="right">
							<span class="count_top"><i class="fa fa-user"></i>
							<spring:message code="top.artists"></spring:message></span>
							<div class="count green">
								<jstl:out value="${totalArtists}"></jstl:out>
							</div>
						</div>
					</div>
					<div
						...
						<div class="left"></div>
						<div class="right">
							<span class="count_top"><i class="fa fa-paint-brush"></i>
							<spring:message code="top.onSaleArtworks"></spring:message></span>
							<div class="count">
								<jstl:out value="${totalOnSaleArtworks}"></jstl:out>
							</div>
						</div>
					</div>
					<div
						...
						<div class="right">
							<span class="count_top"><i class="fa fa-paint-brush"></i>
							<spring:message code="top.soldArtworks"></spring:message></span>
							<div class="count">
								<jstl:out value="${totalsoldArtworks}"></jstl:out>
							</div>
						</div>
					</div>
					<div
						...
						<div class="left"></div>
						<div class="right">
							<span class="count_top"><i class="fa fa-calculator"></i>
							<spring:message code="top.orders"></spring:message></span>
							<div class="count">
								<jstl:out value="${totalOrders}"></jstl:out>
							</div>
						</div>
					</div>
					<div
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="x_panel">
							<div class="x_title">
								<h2>
									<spring:message code="admin.dashboard.findHighestRateArtists" />
								</h2>
								<div class="clearfix"></div>
							</div>
							<div class="x_content">

								<display:table name="highestRateArtists" id="row"
									requestURI="dashboard/admin/dashboard.do" pagesize="5"
									class="table table-bordered">
									<display:column property="name" titleKey="artist.name" />
									<display:column property="surname" titleKey="artist.surname" />
								</display:table>
								<spring:message
									code="admin.dashboard.findNumberHighestRateArtists" />
								:
								<jstl:out value="${numberHighestRateArtists}"></jstl:out>
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="x_panel">
							<div class="x_title">
								<h2>
									<spring:message
										code="admin.dashboard.findMoreArtworksSoldArtists" />
								</h2>
								<div class="clearfix"></div>
							</div>
							<div class="x_content">

								<display:table name="moreArtworksSoldArtists" id="row"
									requestURI="dashboard/admin/dashboard.do" pagesize="5"
									class="table table-bordered">
									<display:column property="name" titleKey="artist.name" />
									<display:column property="surname" titleKey="artist.surname" />
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="x_panel">
							<div class="x_title">
								<h2>
									<spring:message
										code="admin.dashboard.findArtistEarnedMoreMoney" />
								</h2>
								<div class="clearfix"></div>
							</div>
							<div class="x_content">
								<display:table name="artistsEarnedMoreMoney" id="row"
									requestURI="dashboard/admin/dashboard.do" pagesize="5"
									class="table table-bordered">
									<display:column property="name" titleKey="artist.name" />
									<display:column property="surname" titleKey="artist.surname" />
								...
								<spring:message
									code="admin.dashboard.findQuantityArtistEarnedMoreMoney" />
								:
								<jstl:out value="${quantityArtistEarnedMoreMoney}"></jstl:out>
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="x_panel">
							<div class="x_title">
								<h2>
									<spring:message code="admin.dashboard.mostExpensiveOnSale" />
								</h2>
								<div class="clearfix"></div>
							</div>
							<div class="x_content">

								<display:table name="mostExpensiveOnSale" id="row"
									requestURI="dashboard/admin/dashboard.do" pagesize="5"
									class="table table-bordered">
									<display:column property="title" titleKey="artwork.title" />
									<display:column property="description"
										titleKey="artwork.description" />
								</display:table>
							</div>
						</div>
					</div>
