				...
				<div class="left_col scroll-view">
					...
					<div class="sidebar-footer hidden-small">
						<a href="j_spring_security_logout" data-toggle="tooltip"
							data-placement="top" title="<spring:message code="dashboard.logout"></spring:message>"> <span
				...
				<div class="row">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="x_panel">
							<div class="x_title">
								<h2>
									<spring:message code="dashboard.onSaleArtwork.list.title"></spring:message>
								</h2>
								<div class="clearfix"></div>
							</div>
							<div class="x_content">
								<div class="table-responsive">
									<table id="datatable-responsive"
										...
										<thead>
											<tr>
												<th><spring:message
														code="dashboard.soldArtwork.picture"></spring:message></th>
												<th><spring:message code="dashboard.soldArtwork.ticker"></spring:message></th>
												<th><spring:message code="dashboard.soldArtwork.title"></spring:message></th>
												<th><spring:message
														code="dashboard.soldArtwork.description"></spring:message></th>
												<th><spring:message
														code="dashboard.soldArtwork.discipline"></spring:message></th>
												<th><spring:message code="dashboard.soldArtwork.width"></spring:message></th>
												<th><spring:message code="dashboard.soldArtwork.height"></spring:message></th>
												<th><spring:message code="dashboard.soldArtwork.moment"></spring:message></th>
												<th><spring:message code="dashboard.soldArtwork.status"></spring:message></th>
												<th><spring:message code="dashboard.soldArtwork.price"></spring:message></th>
												<th><spring:message
														code="dashboard.soldArtwork.totalCost"></spring:message></th>
											</tr>
										</thead>
										<tbody>

											<jstl:forEach items="${onSaleArtworks}" var="artwork">
												<tr>
													<td><img alt="img" class="img-responsive"
														src="artwork/show.do?artworkId=<jstl:out value="${artwork.id}"></jstl:out>"></td>
													<td><jstl:out value="${artwork.ticker}"></jstl:out></td>
													<td><jstl:out value="${artwork.title}"></jstl:out></td>
													<td><jstl:out value="${artwork.description}"></jstl:out></td>
													<td><jstl:out value="${artwork.discipline}"></jstl:out></td>
													<td><jstl:out value="${artwork.width}"></jstl:out></td>
													<td><jstl:out value="${artwork.height}"></jstl:out></td>
													<td><jstl:out value="${artwork.moment}"></jstl:out></td>
													<td><jstl:out value="${artwork.status}"></jstl:out></td>
													<td><jstl:out value="${artwork.price}"></jstl:out></td>
													<td><jstl:out value="${artwork.totalCost}"></jstl:out></td>
												</tr>
											</jstl:forEach>
										</tbody>
									</table>
