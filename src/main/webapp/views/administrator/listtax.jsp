				...
				<div class="row">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="x_panel">
							<div class="x_title">
								<h2>
									<spring:message code="dashboard.tax.list.title"></spring:message>
								</h2>
								<div class="clearfix"></div>
							</div>
							<div class="x_content">
								...
								<div class="table-responsive">
									<table id="datatable-responsive"
										...
										<thead>
											<tr>
												<th><spring:message code="dashboard.tax.name"></spring:message></th>
												<th><spring:message code="dashboard.tax.value"></spring:message></th>
												<th><spring:message code="dashboard.tax.options"></spring:message></th>
											</tr>
										</thead>
										<tbody>

											<jstl:forEach items="${taxes}" var="tax">
												<tr>
													<td><jstl:out value="${tax.name}"></jstl:out></td>
													<td><jstl:out value="${tax.value}%"></jstl:out></td>
													<td><security:authorize
															access="hasRole('ADMINISTRATOR')">

															<a href="dashboard/admin/edittax.do?taxId=${tax.id}"><spring:message
																	code="tax.edit" /></a>
						...
						<security:authorize access="hasRole('ADMINISTRATOR')">
							<a type="button" class="btn btn-success"
								href="dashboard/admin/createtax.do"> <spring:message
									code="tax.create" />
							</a>
						</security:authorize>
