			...
			<div class="right_col" role="main">
				...
				<div class="row tile_count">
					<div
						...
						<div class="left"></div>
						<div class="right">
							<span class="count_top"><i class="fa fa-user"></i> <spring:message code="top.purchasers"></spring:message></span>
					...
					<div
						...
						<div class="left"></div>
						<div class="right">
							<span class="count_top"><i class="fa fa-user"></i> <spring:message code="top.artists"></spring:message></span>
							<div class="count">
					...
					<div
						...
						<div class="left"></div>
						<div class="right">
							<span class="count_top"><i class="fa fa-paint-brush"></i> <spring:message code="top.onSaleArtworks"></spring:message></span>
							<div class="count">
					...
					<div
						...
						<div class="left"></div>
						<div class="right">
							<span class="count_top"><i class="fa fa-paint-brush"></i> <spring:message code="top.soldArtworks"></spring:message></span>
							<div class="count">
					...
					<div
						...
						<div class="left"></div>
						<div class="right">
							<span class="count_top"><i class="fa fa-calculator"></i> <spring:message code="top.orders"></spring:message></span>
							<div class="count">
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="x_panel">
							<div class="x_title">
								<h2>
									<spring:message code="admin.dashboard.moreArtworksBought" />
								</h2>
								<div class="clearfix"></div>
							</div>
							<div class="x_content">

								<display:table name="moreArtworksBought" id="row"
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="x_panel">
							<div class="x_title">
								<h2>
									<spring:message code="admin.dashboard.purchaserSpendMoreMoney" />
								</h2>
								<div class="clearfix"></div>
							</div>
							<div class="x_content">
