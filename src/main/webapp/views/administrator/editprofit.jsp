				...
				<div class="row">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="x_panel">
							...
							<div class="x_content">
								<br>
								<form:form action="dashboard/admin/editprofit.do"
									modelAttribute="profit"
									...
									<%-- 	<jstl:if test="${tax.getId()!=0 }"> --%>
									<%-- 		<acme:submit name="delete" code="tax.delete"/> --%>
									<%-- 	</jstl:if>	 --%>

									<div class="form-group">
										<label for="middle-name"
											class="control-label col-md-3 col-sm-3 col-xs-12"> <spring:message
												code="profit.value"></spring:message>
										</label>
										<div class="col-md-6 col-sm-6 col-xs-12">
											...
											<ul id="parsley-id-0117" class="parsley-errors-list">
									...
									<div class="form-group">
										<label for="middle-name"
											class="control-label col-md-3 col-sm-3 col-xs-12"> <spring:message
												code="profit.lowerLimit"></spring:message>
										</label>
										<div class="col-md-6 col-sm-6 col-xs-12">
											...
											<ul id="parsley-id-0117" class="parsley-errors-list">
												<form:errors path="lowerLimit"></form:errors>
											</ul>
										</div>
									</div>
									<div class="form-group">
										<label for="middle-name"
											class="control-label col-md-3 col-sm-3 col-xs-12"> <spring:message
												code="profit.upperLimit"></spring:message>
										</label>
										<div class="col-md-6 col-sm-6 col-xs-12">

											<form:input path="upperLimit"
												cssClass="form-control col-md-7 col-xs-12" />

											<ul id="parsley-id-0117" class="parsley-errors-list">
												<form:errors path="upperLimit"></form:errors>
											</ul>
										</div>
									</div>
									...
									<div class="form-group">
										<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
											<button type="submit" name="save" class="btn btn-success">
												<spring:message code="profit.save"></spring:message>
											</button>

											<input type="button" name="cancel" class="btn btn-primary"
												value="<spring:message code="tax.cancel"/>"
												onclick="javascript: window.location.replace('dashboard/admin/listprofit.do')" />
