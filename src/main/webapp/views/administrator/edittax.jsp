				...
				<div class="row">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="x_panel">
							...
							<div class="x_content">
								<br>
								<form:form action="dashboard/admin/edittax.do"
									modelAttribute="tax" cssClass="form-horizontal form-label-left">


									<form:hidden path="id" />
									<form:hidden path="version" />
									<form:hidden path="artworks" />
									...
									<div class="form-group">
										<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
											<button type="submit" name="save" class="btn btn-success">
												<spring:message code="tax.save"></spring:message>
											</button>

											<input type="button" name="cancel" class="btn btn-primary"
												value="<spring:message code="tax.cancel"/>"
												onclick="javascript: window.location.replace('dashboard/admin/listtax.do')" />
